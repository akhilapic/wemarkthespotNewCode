...
Route::get('/my_account','App\Http\Controllers\LoginController@myaccount')->name('my_account')->middleware('Website');
  ...
  Route::get('/contact', 'App\Http\Controllers\FitnessTrainerController@getcontact')->middleware('rememberme');
...
Route::get('/faq', [App\Http\Controllers\FitnessTrainerController::class, 'getfaq'])->middleware('rememberme');

Route::get('/add_Faq', [App\Http\Controllers\FitnessTrainerController::class, 'add_Faq'])->middleware('rememberme');

Route::post('/Faq-data', [App\Http\Controllers\FitnessTrainerController::class, 'Faq_data'])->middleware('rememberme');


Route::get('/Faq_delete/{id}', [App\Http\Controllers\FitnessTrainerController::class, 'Faq_delete'])->name('Faq_delete')->middleware('rememberme');
...
Route::post('/about-data', [App\Http\Controllers\FitnessTrainerController::class, 'aboutdata'])->middleware('rememberme');
...
Route::post('/submitSubcriptionPayment',[App\Http\Controllers\SubscriptionsController::class, 'submitSubcriptionPayment'])->name('submitSubcriptionPayment')->middleware('Website');
